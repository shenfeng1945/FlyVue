...
!function (i) {
  ...
  !function (t) {
    ...
    } else document.attachEvent && (c = t, a = i.document, l = !1, o = function o() {
      l || (l = !0, c());
    }, (_n = function n() {
      try {
    ...
    var t, e, c, a, l, o;
    (t = document.createElement("div")).innerHTML = n, n = null, (e = t.getElementsByTagName("svg")[0]) && (e.setAttribute("aria-hidden", "true"), e.style.position = "absolute", e.style.width = 0, e.style.height = 0, e.style.overflow = "hidden", c = e, (a = document.body).firstChild ? (l = c, (o = a.firstChild).parentNode.insertBefore(l, o)) : a.appendChild(c));
  });
}(window);
